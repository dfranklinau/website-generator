...
class MarkdownParser {
    constructor(renderer, shortcodes) {
        ...
        this._md.block.ruler.enable(['deflist']);
        this._md.use((remarkable) => {
            ...
            remarkable.renderer.rules.heading_open = (tokens, idx) => `<h${tokens[idx].hLevel} id="${markdown_toc_1.default.slugify(tokens[idx + 1].content)}">`;
        });
