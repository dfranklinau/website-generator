...
const fetchResource = async (resource) => {
    const pathname = path_1.default.join(ROOT, resource);
...
const httpServer = http_1.default.createServer(async (request, response) => {
    ...
    try {
        ...
        if (resource.pathname.endsWith(".html")) {
            resource.body = node_buffer_1.Buffer.from(resource.body.toString().replace("</body>", '<script src="/client.js"></script>'));
        }
