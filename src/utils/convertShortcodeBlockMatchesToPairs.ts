import type { ShortcodeBlockMatchesType } from '../parseShortcodes';

export type ShortcodeBlockPairType = number[];
export type ShortcodeBlockPairsType = ShortcodeBlockPairType[];
...
export const convertShortcodeBlockMatchesToPairs = (
  ...
  return pairs.sort((a: number[], b: number[]) => a[0] - b[0]);
};
