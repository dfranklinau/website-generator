...
tape_1.default('`saveContentToFile`', (t) => {
    ...
    saveContentToFile_1.saveContentToFile('content', './build/index.html');
    ...
    saveContentToFile_1.saveContentToFile('content', './build/directory/index.html');
    ...
    mkdirSync.resetHistory();
    writeFileSync.resetHistory();
    saveContentToFile_1.saveContentToFile('content', './build/directory/content/index.html');
